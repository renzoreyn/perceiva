...
export default function DashboardClient({ data, budgetProgress }: { data: DashboardData; budgetProgress: BudgetProgress[] }) {
  ...
  return (
    <div className="flex min-h-screen relative" style={{ background: "var(--bg)" }}>
      ...
      <main className="flex-1 overflow-auto relative z-10" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
        <div className="page">
          ...
          {/* Summary cards */}
          <div className="grid gap-4 mb-4 grid-4col" style={{ gridTemplateColumns: "repeat(4,1fr)" }}>
            {[
          ...
          {/* Main grid */}
          <div className="grid gap-4 grid-2col" style={{ gridTemplateColumns: "1fr 300px" }}>
